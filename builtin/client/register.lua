...
core.registered_on_item_secondary_use, core.register_on_item_secondary_use = make_registration()
core.registered_on_wield_animation, core.register_on_wield_animation = make_registration()
...
core.registered_on_input, core.register_on_input = make_registration()
