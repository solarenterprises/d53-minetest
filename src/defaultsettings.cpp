...
void set_default_settings()
{
	...
	settings->setDefault("addresslist_file", "addresslist.json");

	// General font settings
	settings->setDefault("font_path", porting::getDataPath("fonts" DIR_DELIM "D53-Regular.ttf"));
	settings->setDefault("font_path_italic", porting::getDataPath("fonts" DIR_DELIM "D53-Italic.ttf"));
	settings->setDefault("font_path_bold", porting::getDataPath("fonts" DIR_DELIM "D53-Bold.ttf"));
	settings->setDefault("font_path_bold_italic", porting::getDataPath("fonts" DIR_DELIM "D53-BoldItalic.ttf"));
	...
	settings->setDefault("max_packets_per_iteration", "10000");
