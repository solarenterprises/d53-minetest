...
2. Before you start coding, consider opening an
   [issue at Github](https://github.com/district53/minetest/issues) to discuss the
...
3. Start coding!
    - Refer to the
      [Lua API](https://github.com/district53/minetest/blob/master/doc/lua_api.md),
      [Developer Wiki](http://dev.minetest.net/Main_Page) and other
      [documentation](https://github.com/district53/minetest/tree/master/doc).
...
5. Once you are happy with your changes, submit a pull request.
     - Open the [pull-request form](https://github.com/district53/minetest/pull/new/master).
...
3. [Open an issue](https://github.com/district53/minetest/issues/new) and describe
...
- Who intends to merge the pull-request should follow the commit rules:
    ...
    - `curl https://github.com/district53/minetest/pull/1.patch | git am`
...
- Tag issues with the appropriate [labels](https://github.com/district53/minetest/labels) for devices, platforms etc.
